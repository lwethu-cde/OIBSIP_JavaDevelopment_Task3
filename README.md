# ATM Interface
Project Overview: This project is a console-based ATM simulation built in Java. The system allows a user to log in with a User ID and password once authenticated they can perform basic ATM operations such as: Viewing Transaction History, 
Withdraw money,  Deposit money, Transfer money to another user, Exit the system once they are done.

This project is structured into five classes:
